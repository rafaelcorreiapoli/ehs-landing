Template.main.onRendered(function() {
  ...
  function send_form(type) {
    ...
    if (type == "write_us") {
      var dataString = '&name=' + name + '&surname=' + surname + '&email=' + email + '&city=' + city + '&country=' + country + '&phone=' + phone + '&message=' + message;
    }
    if (type == "booknow") {
      var dataString = '&arrival=' + arrival + '&departure=' + departure + '&adult=' + adult + '&child=' + child + '&coupon=' + coupon;
    }
    if (type == "reserve") {
  ...
  */
  ...
  $("#fluxograma-toggle").mouseleave(function() {
    $(this).attr("src", "images/conteudo/fluxograma1.png");
  })
})
